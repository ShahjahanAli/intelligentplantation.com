    ...
    <footer class="py-12 px-4 bg-gray-900 text-white">
      <div class="max-w-7xl mx-auto">
        <div class="grid grid-cols-2 md:grid-cols-5 gap-8 mb-12">
          <div class="col-span-2 md:col-span-1">
            <div class="flex items-center gap-2 mb-4">
              ...
              <span class="font-bold text-lg">PlantIQ</span>
            </div>
            <p class="text-gray-400 text-sm">
              AI-powered plant management for smarter, healthier gardens.
            </p>
          </div>
        ...
        <div class="border-t border-gray-800 pt-8 flex flex-col md:flex-row items-center justify-between gap-4">
          <p class="text-gray-400 text-sm">© 2024 PlantIQ. All rights reserved.</p>
